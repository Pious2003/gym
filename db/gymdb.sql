...
(
    payment_detail_id uuid NOT NULL DEFAULT gen_random_uuid(),
    paymentid uuid,
    courseid uuid,
    price numeric(10, 2),
    customerid uuid,
...
(
    ...
    servicename character varying(50) COLLATE pg_catalog."default" NOT NULL,
...
ALTER TABLE IF EXISTS public.payment_detail
    ADD CONSTRAINT payment_detail_paymentid_fkey FOREIGN KEY (paymentid)
    REFERENCES public.payment (paymentid) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS public.payment_detail
    ADD CONSTRAINT payment_detail_courseid_fkey FOREIGN KEY (courseid)
...
ALTER TABLE IF EXISTS public.payment_detail
    ADD CONSTRAINT payment_detail_customerid_fkey FOREIGN KEY (customerid)
    REFERENCES public.customer (customerid) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS public.workoutcourse
    ADD CONSTRAINT workoutcourse_serviceid_fkey FOREIGN KEY (serviceid)
    REFERENCES public.service (serviceid) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
